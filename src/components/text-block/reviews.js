      ...
      <Paper zDepth={1} className={cls(this.initClass, className)}>
        ...
        <div className={cls(this.initClass + "-content")}>
          <div className="positivePorcentage">
            <span>Positive</span>
            <div
              className={`porcentageContainer ${this.renderClassName(
                positivePorcentage
              )}`}
            >
              <div className="fill">
                <FontIcon>sentiment_very_satisfied</FontIcon>
              </div>
            </div>
          ...
          <div className="negativePorcentage">
            ...
            >
              <div className="fill">
                <FontIcon>sentiment_very_dissatisfied</FontIcon>
              </div>
            </div>
        ...
        <div className={cls(this.initClass + "-footer")}>
          <Button flat className="buttonSee">
            See all reviews
          </Button>
          <Button flat className="buttonAdd">
            Add review
          </Button>
        </div>
      </Paper>
